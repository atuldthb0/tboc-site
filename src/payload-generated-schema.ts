...
export const enum_pages_blocks_logo_loop_direction = pgEnum(
  'enum_pages_blocks_logo_loop_direction',
  ['left', 'right', 'up', 'down'],
)
...
export const enum__pages_v_blocks_logo_loop_direction = pgEnum(
  'enum__pages_v_blocks_logo_loop_direction',
  ['left', 'right', 'up', 'down'],
)
...
export const pages_blocks_big_dream_c_t_a_trust_indicators = pgTable(
  'pages_blocks_big_dream_c_t_a_trust_indicators',
  {
    _order: integer('_order').notNull(),
  ...
  (columns) => [
    index('pages_blocks_big_dream_c_t_a_trust_indicators_order_idx').on(columns._order),
    index('pages_blocks_big_dream_c_t_a_trust_indicators_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_big_dream_c_t_a.id],
      name: 'pages_blocks_big_dream_c_t_a_trust_indicators_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const pages_blocks_big_dream_c_t_a = pgTable(
  'pages_blocks_big_dream_c_t_a',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    ...
    companyTag: varchar('company_tag').default('The Big O Company'),
    headline_firstLine: varchar('headline_first_line').default('The Dream'),
    headline_secondLine: varchar('headline_second_line').default('Project'),
    supportingText: varchar('supporting_text').default(
      "Your vision, our expertise. We're here for you with the bold solutions and unwavering support you need.",
    ),
    ctaButton_label: varchar('cta_button_label').default("Let's Build Together"),
    ctaButton_url: varchar('cta_button_url').default('#'),
    blockName: varchar('block_name'),
  },
  (columns) => [
    index('pages_blocks_big_dream_c_t_a_order_idx').on(columns._order),
    index('pages_blocks_big_dream_c_t_a_parent_id_idx').on(columns._parentID),
    index('pages_blocks_big_dream_c_t_a_path_idx').on(columns._path),
    index('pages_blocks_big_dream_c_t_a_background_image_idx').on(columns.backgroundImage),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages.id],
      name: 'pages_blocks_big_dream_c_t_a_parent_id_fk',
    }).onDelete('cascade'),
  ],
)
...
export const pages_blocks_logo_loop_logos = pgTable(
  'pages_blocks_logo_loop_logos',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
  ...
  (columns) => [
    index('pages_blocks_logo_loop_logos_order_idx').on(columns._order),
    index('pages_blocks_logo_loop_logos_parent_id_idx').on(columns._parentID),
    index('pages_blocks_logo_loop_logos_image_idx').on(columns.image),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_logo_loop.id],
      name: 'pages_blocks_logo_loop_logos_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const pages_blocks_logo_loop = pgTable(
  'pages_blocks_logo_loop',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
    id: varchar('id').primaryKey(),
    speed: numeric('speed', { mode: 'number' }).default(120),
    direction: enum_pages_blocks_logo_loop_direction('direction').default('left'),
    pauseOnHover: boolean('pause_on_hover').default(true),
    scaleOnHover: boolean('scale_on_hover').default(true),
    logoHeight: numeric('logo_height', { mode: 'number' }).default(28),
    gap: numeric('gap', { mode: 'number' }).default(32),
    fadeOut: boolean('fade_out').default(false),
    blockName: varchar('block_name'),
  },
  (columns) => [
    index('pages_blocks_logo_loop_order_idx').on(columns._order),
    index('pages_blocks_logo_loop_parent_id_idx').on(columns._parentID),
    index('pages_blocks_logo_loop_path_idx').on(columns._path),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages.id],
      name: 'pages_blocks_logo_loop_parent_id_fk',
    }).onDelete('cascade'),
  ],
)
...
export const _pages_v_blocks_big_dream_c_t_a_trust_indicators = pgTable(
  '_pages_v_blocks_big_dream_c_t_a_trust_indicators',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => [
    index('_pages_v_blocks_big_dream_c_t_a_trust_indicators_order_idx').on(columns._order),
    index('_pages_v_blocks_big_dream_c_t_a_trust_indicators_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_big_dream_c_t_a.id],
      name: '_pages_v_blocks_big_dream_c_t_a_trust_indicators_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const _pages_v_blocks_big_dream_c_t_a = pgTable(
  '_pages_v_blocks_big_dream_c_t_a',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
  ...
  (columns) => [
    index('_pages_v_blocks_big_dream_c_t_a_order_idx').on(columns._order),
    index('_pages_v_blocks_big_dream_c_t_a_parent_id_idx').on(columns._parentID),
    index('_pages_v_blocks_big_dream_c_t_a_path_idx').on(columns._path),
    index('_pages_v_blocks_big_dream_c_t_a_background_image_idx').on(columns.backgroundImage),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v.id],
      name: '_pages_v_blocks_big_dream_c_t_a_parent_id_fk',
    }).onDelete('cascade'),
  ],
)
...
export const _pages_v_blocks_logo_loop_logos = pgTable(
  '_pages_v_blocks_logo_loop_logos',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => [
    index('_pages_v_blocks_logo_loop_logos_order_idx').on(columns._order),
    index('_pages_v_blocks_logo_loop_logos_parent_id_idx').on(columns._parentID),
    index('_pages_v_blocks_logo_loop_logos_image_idx').on(columns.image),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_logo_loop.id],
      name: '_pages_v_blocks_logo_loop_logos_parent_id_fk',
    }).onDelete('cascade'),
  ],
)

export const _pages_v_blocks_logo_loop = pgTable(
  '_pages_v_blocks_logo_loop',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _path: text('_path').notNull(),
    id: serial('id').primaryKey(),
    speed: numeric('speed', { mode: 'number' }).default(120),
    direction: enum__pages_v_blocks_logo_loop_direction('direction').default('left'),
    pauseOnHover: boolean('pause_on_hover').default(true),
    scaleOnHover: boolean('scale_on_hover').default(true),
    logoHeight: numeric('logo_height', { mode: 'number' }).default(28),
    gap: numeric('gap', { mode: 'number' }).default(32),
  ...
  (columns) => [
    index('_pages_v_blocks_logo_loop_order_idx').on(columns._order),
    index('_pages_v_blocks_logo_loop_parent_id_idx').on(columns._parentID),
    index('_pages_v_blocks_logo_loop_path_idx').on(columns._path),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v.id],
      name: '_pages_v_blocks_logo_loop_parent_id_fk',
    }).onDelete('cascade'),
  ],
)
...
export const relations_pages_blocks_big_dream_c_t_a_trust_indicators = relations(
  pages_blocks_big_dream_c_t_a_trust_indicators,
  ({ one }) => ({
    _parentID: one(pages_blocks_big_dream_c_t_a, {
      fields: [pages_blocks_big_dream_c_t_a_trust_indicators._parentID],
      references: [pages_blocks_big_dream_c_t_a.id],
      relationName: 'trustIndicators',
    }),
  }),
)
export const relations_pages_blocks_big_dream_c_t_a = relations(
  pages_blocks_big_dream_c_t_a,
  ({ one, many }) => ({
    _parentID: one(pages, {
      fields: [pages_blocks_big_dream_c_t_a._parentID],
      references: [pages.id],
      relationName: '_blocks_bigDreamCTA',
    }),
    backgroundImage: one(media, {
      fields: [pages_blocks_big_dream_c_t_a.backgroundImage],
      references: [media.id],
      relationName: 'backgroundImage',
    }),
    trustIndicators: many(pages_blocks_big_dream_c_t_a_trust_indicators, {
      relationName: 'trustIndicators',
    }),
  }),
)
...
export const relations_pages_blocks_logo_loop_logos = relations(
  pages_blocks_logo_loop_logos,
  ({ one }) => ({
    _parentID: one(pages_blocks_logo_loop, {
      fields: [pages_blocks_logo_loop_logos._parentID],
      references: [pages_blocks_logo_loop.id],
      relationName: 'logos',
    }),
    image: one(media, {
      fields: [pages_blocks_logo_loop_logos.image],
      references: [media.id],
      relationName: 'image',
    }),
  }),
)
export const relations_pages_blocks_logo_loop = relations(
  pages_blocks_logo_loop,
  ({ one, many }) => ({
    _parentID: one(pages, {
      fields: [pages_blocks_logo_loop._parentID],
      references: [pages.id],
      relationName: '_blocks_logoLoop',
    }),
    logos: many(pages_blocks_logo_loop_logos, {
      relationName: 'logos',
    }),
  }),
)
...
export const relations_pages = relations(pages, ({ one, many }) => ({
  ...
  _blocks_bigDreamCTA: many(pages_blocks_big_dream_c_t_a, {
    relationName: '_blocks_bigDreamCTA',
  }),
  ...
  _blocks_logoLoop: many(pages_blocks_logo_loop, {
    relationName: '_blocks_logoLoop',
  }),
...
export const relations__pages_v_blocks_big_dream_c_t_a_trust_indicators = relations(
  _pages_v_blocks_big_dream_c_t_a_trust_indicators,
  ({ one }) => ({
    _parentID: one(_pages_v_blocks_big_dream_c_t_a, {
      fields: [_pages_v_blocks_big_dream_c_t_a_trust_indicators._parentID],
      references: [_pages_v_blocks_big_dream_c_t_a.id],
      relationName: 'trustIndicators',
    }),
  }),
)
export const relations__pages_v_blocks_big_dream_c_t_a = relations(
  _pages_v_blocks_big_dream_c_t_a,
  ({ one, many }) => ({
    _parentID: one(_pages_v, {
      fields: [_pages_v_blocks_big_dream_c_t_a._parentID],
      references: [_pages_v.id],
      relationName: '_blocks_bigDreamCTA',
    }),
    backgroundImage: one(media, {
      fields: [_pages_v_blocks_big_dream_c_t_a.backgroundImage],
      references: [media.id],
      relationName: 'backgroundImage',
    }),
    trustIndicators: many(_pages_v_blocks_big_dream_c_t_a_trust_indicators, {
      relationName: 'trustIndicators',
    }),
  }),
)
...
export const relations__pages_v_blocks_logo_loop_logos = relations(
  _pages_v_blocks_logo_loop_logos,
  ({ one }) => ({
    _parentID: one(_pages_v_blocks_logo_loop, {
      fields: [_pages_v_blocks_logo_loop_logos._parentID],
      references: [_pages_v_blocks_logo_loop.id],
      relationName: 'logos',
    }),
    image: one(media, {
      fields: [_pages_v_blocks_logo_loop_logos.image],
      references: [media.id],
      relationName: 'image',
    }),
  }),
)
export const relations__pages_v_blocks_logo_loop = relations(
  _pages_v_blocks_logo_loop,
  ({ one, many }) => ({
    _parentID: one(_pages_v, {
      fields: [_pages_v_blocks_logo_loop._parentID],
      references: [_pages_v.id],
      relationName: '_blocks_logoLoop',
    }),
    logos: many(_pages_v_blocks_logo_loop_logos, {
      relationName: 'logos',
    }),
  }),
)
...
export const relations__pages_v = relations(_pages_v, ({ one, many }) => ({
  ...
  _blocks_bigDreamCTA: many(_pages_v_blocks_big_dream_c_t_a, {
    relationName: '_blocks_bigDreamCTA',
  }),
  ...
  _blocks_logoLoop: many(_pages_v_blocks_logo_loop, {
    relationName: '_blocks_logoLoop',
  }),
...
type DatabaseSchema = {
  ...
  enum_pages_blocks_logo_loop_direction: typeof enum_pages_blocks_logo_loop_direction
  ...
  enum__pages_v_blocks_logo_loop_direction: typeof enum__pages_v_blocks_logo_loop_direction
  ...
  pages_blocks_big_dream_c_t_a_trust_indicators: typeof pages_blocks_big_dream_c_t_a_trust_indicators
  pages_blocks_big_dream_c_t_a: typeof pages_blocks_big_dream_c_t_a
  ...
  pages_blocks_logo_loop_logos: typeof pages_blocks_logo_loop_logos
  pages_blocks_logo_loop: typeof pages_blocks_logo_loop
  pages: typeof pages
  pages_rels: typeof pages_rels
  _pages_v_version_hero_links: typeof _pages_v_version_hero_links
  _pages_v_blocks_big_dream_c_t_a_trust_indicators: typeof _pages_v_blocks_big_dream_c_t_a_trust_indicators
  _pages_v_blocks_big_dream_c_t_a: typeof _pages_v_blocks_big_dream_c_t_a
  ...
  _pages_v_blocks_logo_loop_logos: typeof _pages_v_blocks_logo_loop_logos
  _pages_v_blocks_logo_loop: typeof _pages_v_blocks_logo_loop
  ...
  relations_pages_blocks_big_dream_c_t_a_trust_indicators: typeof relations_pages_blocks_big_dream_c_t_a_trust_indicators
  relations_pages_blocks_big_dream_c_t_a: typeof relations_pages_blocks_big_dream_c_t_a
  ...
  relations_pages_blocks_logo_loop_logos: typeof relations_pages_blocks_logo_loop_logos
  relations_pages_blocks_logo_loop: typeof relations_pages_blocks_logo_loop
  ...
  relations__pages_v_blocks_big_dream_c_t_a_trust_indicators: typeof relations__pages_v_blocks_big_dream_c_t_a_trust_indicators
  relations__pages_v_blocks_big_dream_c_t_a: typeof relations__pages_v_blocks_big_dream_c_t_a
  ...
  relations__pages_v_blocks_logo_loop_logos: typeof relations__pages_v_blocks_logo_loop_logos
  relations__pages_v_blocks_logo_loop: typeof relations__pages_v_blocks_logo_loop
